# Startprompt für ChatGPT — als ERSTE Nachricht einfügen

> Nur dieser Text kommt in die erste Nachricht, zusammen mit dem Übungs- und
> Klausurmaterial. Die Nachschärf-Prompts stehen in der zweiten Datei und
> werden erst später gebraucht — nicht mit hineinkopieren.
...
**Wenn ich das Material in mehreren Nachrichten hochlade:** warte mit dem Inventar, bis ich
„Material vollständig" schreibe. Sag mir nach jedem Schwung nur kurz, was angekommen ist.
Ein Inventar, das auf halbem Material beruht, ist wertlos — dann fehlen mir in der Klausur
genau die Aufgaben aus den Dateien, die noch nicht da waren.
